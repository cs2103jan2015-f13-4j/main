...
public class KeywordType {
	...
	public enum List_SearchKeywords{
		ALL, COMPLETED, PENDING, DESCRIPTION, DEADLINE, STARTDATE, TODAY, TOMORROW, TMR, YESTERDAY, YTD, MONDAY, MON, TUESDAY, TUE, WEDNESDAY, WED, THURSDAY, THU, FRIDAY, FRI, SATURDAY, SAT, SUNDAY, SUN
	}
