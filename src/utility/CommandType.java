...
public class CommandType {
	...
	// @author A0112502A
	/**
	 * This method will check the commands input by the user and go to the
	 * necessary case
	 * 
	 * @param commandTypeString
	 *            is the command type that user has input
	 * @return the corresponding command type with the commandTypeString
	 *         received
	 */
